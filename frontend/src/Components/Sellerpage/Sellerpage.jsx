        ...
        <div className="buyer-container">
          {sellerdata.map((data, index) => (
            <div className="buyer-card" key={index}>
                  ...
                  <tr>
                    ...
                    <td>
                      {(() => {
                        ...
                        if (data.role.BusinessSellOuts)
                          roles.push(" Business Sell Outs");
                        if (data.role.InvestPartners)
                          roles.push("Invest Partners");
                        if (data.role.SharePartners)
                          roles.push("Share Partners");
                        if (data.role.WorkingPartners)
                          roles.push("Working Partners");
              ...
              <button
                className={activeSellerId === data._id ? "morehide" : "more"}
