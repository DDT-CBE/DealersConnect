...
const Pricing = () => {
  return (
    <div className=" h-screen w-screen px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 flex justify-center border">
        <Nav2 />
    <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
      <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs">
        <div className="p-6 sm:px-8">
          ...
          <a
            className="mt-4 block rounded-sm border border-yellow-600 bg-yellow-400 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-yellow-600 focus:ring-3 focus:outline-hidden sm:mt-6"
            href="#"
          >
            Get Started
          </a>
