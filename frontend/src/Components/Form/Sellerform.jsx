...
const [seekerType ,setSeekerType] = useState("");
  ...
  const submithandler = (e) => {
    ...
    axios
      .post(`${url}api/sellerregister`, sellerdata)
      .then((res) => {
...
<label className="sellerform-label">Business Seeker Type</label>
<select 
  className="sellerform-input"
  value={seekerType} 
  onChange={(e) => setSeekerType(e.target.value)}
>
  <option value="">Select Business Seeker Type</option>
  ...
  <option value="Business Buy Outs">Business Buy Outs</option>
  <option value="Invest Partners">Invest Partners</option>
  <option value="Share Partners">Share Partners</option>
  <option value="Working Partners">Working Partners</option>
  <option value="Share Buyers">Share Buyers</option>
  <option value="Seed Funders">Seed Funders</option>
  <option value="Angel Funders">Angel Funders</option>
...
) :  ["Franchisee"].includes(seekerType) ? (
...
{industry === "Textile, Fabrics & Accessories" && (
  <>
    ...
    <option value="Woven Fabrics">Woven Fabrics</option>
        ...
        <label className="sellerform-label">Product/Service</label>
        <input
          className="sellerform-input"
          type="text"
          value={product}
        ...
        <input
          className="sellerform-input"
          type="number"
          value={investmentminimum}
          onChange={(e) => setInvestmentMinimum(e.target.value)}
        />
        <label className="sellerform-label">Investment Maximum</label>
        <input
          className="sellerform-input"
          type="number"
          value={investmentmaximum}
          onChange={(e) => setInvestmentMaximum(e.target.value)}
        />
        <label className="sellerform-label">Space Required</label>
        <input
          className="sellerform-input"
          type="text"
          value={space}
